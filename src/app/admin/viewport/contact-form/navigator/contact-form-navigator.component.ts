...
@Component({
  selector: 'app-contact-form-navigator',
  templateUrl: './contact-form-navigator.component.html',
  styleUrls: ['./contact-form-navigator.component.scss'],
  animations: [fadeInUpStaggerEnter]
})
export class ContactFormNavigatorComponent implements OnInit, OnDestroy {
  ...
  onLangChanges() {
    ...
    this.title.setTitle(this.translateSer.instant('contact-form-page.page-title'));
  }
}
